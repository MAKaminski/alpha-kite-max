        ...
        <DarkModeProvider>
          ...
          <div className="sticky top-0 z-40 bg-white/80 dark:bg-gray-900/80 backdrop-blur border-b border-gray-200 dark:border-gray-800">
            <div className="max-w-7xl mx-auto px-4 py-2 flex items-center gap-3 text-sm">
              ...
              <Link href="/options" className={`px-3 py-1 rounded ${pathname.startsWith('/options') ? 'bg-blue-600 text-white' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800'}`}>Options</Link>
            </div>
          </div>
          {children}
        </DarkModeProvider>
